-- ==========================================
-- JUICY APP: PRODUCTION CHECKOUT SYNC (V6)
-- Atomic Order Placement + Stock Management
-- ==========================================

-- 1. DROP OLD VERSIONS TO PREVENT CONFLICTS
DROP FUNCTION IF EXISTS public.place_order_v1(uuid, text, numeric, text, jsonb, text, numeric, numeric, numeric, numeric, text, text);

-- 2. CREATE THE FINAL PRODUCTION RPC
